...
export default class SilkyMaterial2 extends ShaderMaterial {
  constructor(options) {
    super({
      clipping: true,
      uniforms: {
        ...
        u_scale: { value: 5 },
        u_background: { value: new Color('#093060') },
        u_foreground: { value: new Color('#77bdde') },
        u_distort: { value: 50 },
        u_radius: { value: .5 },
      },
