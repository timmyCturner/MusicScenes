...
const distortFactor = (progress) => {
  ...
  //   return 0.8;
  // }
  if (progress > 0.213675213675214 && progress < 0.5) {
    return 0.4;
  } else if (progress > 0.5 && progress < 0.82051282051282) {
    return 0.6;
  } else if (progress > 0.82051282051282 && progress < 0.923076923076923) {
    return 0.8;
  }
  ...
  setProgress: (progress) =>
    set(() => {
      ...
      return {
        progress,
        sparkStorm:
          progress > 0.16578355523428323 && progress < 0.95 ? true : false,
        planetDistortion:
          progress > 0.0 && progress < 0.95 ? true : false,
        spaceshipDistortion:
